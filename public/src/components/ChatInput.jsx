...
export default function ChatInput({ handleSendMsg }) {
  ...
  // Abre ou fecha o emoji picker ao clicar no ícone
  ...
  return (
    <Container>
      <div className="button-container">
        <div className="emoji" ref={emojiIconRef}>
          <BsEmojiSmileFill onClick={handleEmojiIconClick} />
          {showEmojiPicker && (
